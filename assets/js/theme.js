...
let UomoHelpers = {
  ...
  showPageBackdrop: () => {
    UomoSelectors.$pageBackDrop &&
      UomoSelectors.$pageBackDrop.classList.add(
        UomoSelectors.pageBackDropActiveClass
      );
    ...
    document
      ...
      .forEach((element) => {
        element.style.borderRight =
          UomoSelectors.scrollWidth + " solid transparent";
      });
  },

  hidePageBackdrop: () => {
    UomoSelectors.$pageBackDrop &&
      UomoSelectors.$pageBackDrop.classList.remove(
        UomoSelectors.pageBackDropActiveClass
      );
...
(function () {
  ...
  UomoElements.QtyControl = (function () {
    function QtyControl() {
      document
        .querySelectorAll(UomoSelectors.quantityControl)
  ...
  UomoElements.Search = (function () {
    ...
    Search.prototype = Object.assign({}, Search.prototype, {
        ...
        this.$containers.forEach((el) => {
          ...
          $inputBox &&
            $inputBox.addEventListener("keyup", (e) => {
              ...
              el.querySelectorAll(_this.selectors.searchSuggestItem).forEach(
                (el) => {
           ...
           */
          el.querySelectorAll(_this.selectors.searchCategorySelector).forEach(
            (scs) => {
              scs.addEventListener("click", function (e) {
                e.preventDefault();
                const $s_f_a = el.querySelector(
                  _this.selectors.searchFieldActor
                );
                if ($s_f_a) {
      ...
      _initSearchReset: function () {
        ...
        document.querySelectorAll(this.selectors.resetButton).forEach((el) => {
          el.addEventListener("click", function (e) {
            ...
            const $inputBox = $parentDiv.querySelector(
              _this.selectors.inputBox
            );
            const $rc = $parentDiv.querySelector(
              _this.selectors.resultContainer
            );
      ...
      _updateSearchResult: function (data, $form) {
        ...
        $form.querySelector(this.selectors.resultContainer).innerHTML =
          $f_r.innerHTML;
  ...
  UomoElements.Aside = (function () {
    function Aside() {
      ...
      this.$asideActivators = document.querySelectorAll(
    ...
    Aside.prototype = Object.assign({}, Aside.prototype, {
      _init: function () {
        ...
        $(document).on("click", this.selectors.activator, function (e) {
          ...
          $targetAside &&
            $targetAside.classList.add(_this.selectors.activeClass);
        });
      },
      ...
      _closeAside: function () {
        ...
        document
          .querySelectorAll("." + this.selectors.activeClass)
          .forEach((el) => {
  ...
  UomoElements.Countdown = (function () {
    ...
    Countdown.prototype = Object.assign({}, Countdown.prototype, {
      _init: function () {
        const _this = this;
        const $countdowns = this.$container.querySelectorAll(
  ...
  UomoElements.ShopViewChange = (function () {
    ...
    ShopViewChange.prototype = Object.assign({}, ShopViewChange.prototype, {
      ...
      _resetActiveLinks() {
        ...
        document
          .querySelectorAll(
            `${this.selectors.element}.${this.selectors.activeClass}`
          )
          .forEach(($el) => {
    ...
    StickyElement.prototype = Object.assign({}, StickyElement.prototype, {
      _init: function () {
        ...
        this.$stickies.forEach(function ($sticky) {
          const $grid =
            $sticky.previousElementSibling || $sticky.nextElementSibling;
          const $target =
            $grid.offsetHeight > $sticky.offsetHeight ? $sticky : $grid;
          ...
          UomoHelpers.sideStkEl.initialTopOffset = parseInt(
            window.getComputedStyle($target).top
          );
        });
      ...
      _updateStatus() {
        ...
        _this.$stickies.forEach(function ($sticky) {
          ...
          if (window.scrollY < $target.lastKnownY) {
            UomoHelpers.sideStkEl.currentTop -=
              window.scrollY - $target.lastKnownY;
          } else {
            UomoHelpers.sideStkEl.currentTop +=
              $target.lastKnownY - window.scrollY;
          }
  ...
  UomoSections.Header = (function () {
    ...
    Header.prototype = Object.assign({}, Header.prototype, {
      _init: function () {
        const headerClass = UomoHelpers.isMobile
          ? this.selectors.mobileHeader
      ...
      _initMobileMenu: function () {
        const _this = this;
        const mobileMenuActivator = this.$header.querySelector(
          this.selectors.mobileMenuActivator
        );
        ...
        if ($mobileDropdown) {
              ...
              .on("click", function (event) {
                ...
                if (
                  document.body.classList.contains(
                    _this.selectors.mobileMenuActiveClass
                  )
                ) {
                  ...
                  $mobileDropdown.style.paddingRight =
                    UomoSelectors.scrollWidth;
                }
              });

          const $mobileMenu =
            $mobileDropdown.querySelector(".navigation__list");
          let menuMaxHeight = $mobileMenu.offsetHeight;
          $mobileMenu &&
            $mobileMenu
              .querySelectorAll(_this.selectors.mobileSubNavOpen)
              .forEach(($btn) => {
                $btn.addEventListener("click", function (event) {
                  event.preventDefault;
                  $btn.nextElementSibling.classList.remove(
                    _this.selectors.mobileSubNavHiddenClass
                  );

                  transformLeft -= 100;
                  if (menuMaxHeight < $btn.nextElementSibling.offsetHeight) {
                    $mobileMenu.style.transform =
                      "translateX(" + transformLeft.toString() + "%)";
                    $mobileMenu.style.minHeight =
                      $btn.nextElementSibling.offsetHeight + "px";
                  } else {
                    $mobileMenu.style.transform =
                      "translateX(" + transformLeft.toString() + "%)";
          ...
          $mobileMenu &&
            $mobileMenu
              .querySelectorAll(_this.selectors.mobileSubNavClose)
              .forEach(($btn) => {
                $btn.addEventListener("click", function (event) {
                  event.preventDefault;
                  transformLeft += 100;
      ...
      _initStickyHeader: function () {
        ...
        if (this.$header.classList.contains("header-transparent-bg")) {
          ...
          if (
            document.querySelectorAll(".header-transparent-bg .header-top")
              .length > 0
          ) {
      ...
      _stickyScrollHander() {
        ...
        if (
          ...
          currentScrollTop < this.stickyMinPos
        ) {
  ...
  UomoSections.CustomerSideForm = (function () {
    function CustomerSideForm() {
      ...
      this.$formsWrapper = this.$aside.querySelector(
        this.selectors.formsWrapper
      );
      this.$registerActivator = this.$aside.querySelector(
        this.selectors.registerActivator
      );
      this.$loginActivator = this.$aside.querySelector(
        this.selectors.loginActivator
      );
  ...
  UomoSections.CartDrawer = (function () {
    ...
    CartDrawer.prototype = Object.assign({}, CartDrawer.prototype, {
      ...
      _initCartItemRemoval: function () {
        this.$aside
          .querySelectorAll(this.selectors.cartItemRemover)
          .forEach((el) => {
            el.addEventListener("click", (event) => {
              event.preventDefault();
              ...
              $divider &&
                $divider.classList.contains("cart-drawer-divider") &&
                $divider.classList.add("_removed");
              setTimeout(() => {
                $parentEl.remove();
                $divider &&
                  $divider.classList.contains("cart-drawer-divider") &&
    ...
    SwiperSlideshow.prototype = Object.assign({}, SwiperSlideshow.prototype, {
      _initSliders() {
        this.$containers.forEach(function ($sliderContainer) {
          if (
            $sliderContainer.classList.contains("swiper-container-initialized")
          ) {
            return;
          }
          ...
          if ($sliderContainer.dataset.settings) {
            settings = Object.assign(
              settings,
              JSON.parse($sliderContainer.dataset.settings)
            );
          }
          ...
          if ($sliderContainer.querySelectorAll(".swiper-slide").length > 1) {
            ...
            const $active_slide =
              $sliderContainer.querySelector(".swiper-slide");
  ...
  UomoSections.ProductSingleMedia = (function () {
    ...
    function setSlideHeight(that) {
      ...
      $(
        ".product-single__thumbnail .swiper-wrapper, .product-single__thumbnail .swiper-slide"
      ).css({ height: newHeight });
      that.update();
    }

    ProductSingleMedia.prototype = Object.assign(
      {},
      ProductSingleMedia.prototype,
      {
        _initProductMedia() {
  ...
  UomoElements.StarRating = (function () {
    function StarRating() {
      let stars = Array.from(
        document.querySelectorAll(UomoSelectors.starRatingControl)
      );
      ...
      function pureFadeIn(e, o) {
        ...
        (i.style.opacity = 0),
          ...
          (function e() {
            ...
            (o += 0.02) > 1 ||
              ((i.style.opacity = o), requestAnimationFrame(e));
          })();
      }
      ...
      $containers.forEach((el) => {
        ...
        $selectArray.forEach((el) => {
          el.addEventListener("click", function (e) {
            ...
            const optionIndex = Array.prototype.indexOf
              .call($list.children, e.currentTarget)
              .toString();
      ...
      document.querySelectorAll(selectors.elementClass).forEach(($se) => {
        ...
        if ($se) {
          ...
          priceRange.on("slideStop", (value) => {
            const $minEl = $se.parentElement.querySelector(
              selectors.minElement
            );
            const $maxEl = $se.parentElement.querySelector(
  ...
  $('a[data-bs-toggle="tab"]').on("shown.bs.tab", function (e) {
    ...
    if (
      ...
      document
        .querySelectorAll(".tab-pane" + paneTarget + " .swiper-container")
  ...
  $("#quickView.modal").on("shown.bs.modal", function (e) {
    ...
    if (
      ...
      document
        .querySelectorAll(".modal" + paneTarget + " .swiper-container")
        .forEach(function (item) {
          item.swiper.update();
          item.swiper.lazy.load();
        });
  ...
  $(window).on("scroll", function () {
    if ($(".mobile_fixed-btn_wrapper").length > 0) {
      if ($(this).width() < 992 && $(this).width() >= 768) {
        if (
          $(this).scrollTop() + $(this).height() - 76 <=
            $(".mobile_fixed-btn_wrapper").offset().top &&
          $(this).scrollTop() > $(this).height()
        ) {
          $(".mobile_fixed-btn_wrapper > .button-wrapper").addClass(
            "fixed-btn"
          );
        } else {
          $(".mobile_fixed-btn_wrapper > .button-wrapper").removeClass(
            "fixed-btn"
          );
        }
      } else if ($(this).width() < 768) {
        if (
          $(this).scrollTop() + $(this).height() - 124 <=
            $(".mobile_fixed-btn_wrapper").offset().top &&
          $(this).scrollTop() > $(this).height()
        ) {
          $(".mobile_fixed-btn_wrapper > .button-wrapper").addClass(
...
(function () {
  ...
  Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener(
      ...
      function (event) {
        ...
        form.querySelectorAll("input[data-cf-pwd]").forEach(function (el) {
          if (
            form.querySelector(el.getAttribute("data-cf-pwd")).value != el.value
          ) {
            event.preventDefault();
            event.stopPropagation();
          }
    ...
    form.querySelectorAll("input[data-cf-pwd]").forEach(function (el) {
      ...
      form
        .querySelector(el.getAttribute("data-cf-pwd"))
